...
from srl.base.define import EnvActionType,EnvObservationType,InfoType,InvalidActionType
...
class SinglePlayEnv(EnvBase):
    ...
    def call_step(self,action:EnvActionType) -> Tuple[EnvObservationType,float,bool,InfoType]:
        raise NotImplementedError()
    def call_get_invalid_actions(self) -> InvalidActionType:
        return []
    @property
    ...
    def get_invalid_actions(self,player_index:int) -> InvalidActionType:
